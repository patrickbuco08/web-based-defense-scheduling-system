                    ...
                    <form method="POST" action="{{ route('admin.terms.update', $term) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input id="school_year" 
                                   ...
                                   type="text" 
                                   name="school_year" 
                                   value="{{ old('school_year', $term->school_year) }}" 
                        ...
                        <div class="mb-4">
                            ...
                            <select id="semester" name="semester" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                <option value="1st" {{ $term->semester === '1st' ? 'selected' : '' }}>1st Semester</option>
                                <option value="2nd" {{ $term->semester === '2nd' ? 'selected' : '' }}>2nd Semester</option>

    ...
    <div class="min-h-screen w-full flex items-center justify-center p-4 bg-cover bg-center bg-fixed"
        ...
        <div
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-4">
                ...
                <!-- Confirm Password -->
                <div>
                    <label for="password_confirmation" class="block mb-2 text-sm font-medium text-white/80">Confirm
                        Password</label>
                ...
                <div class="flex items-center justify-between pt-4">
                    <a class="text-sm text-primary hover:text-primary/80 underline" href="{{ route('login') }}">
                        {{ __('Already registered?') }}
                    </a>

                    <button type="submit"
                        class="px-6 py-2 font-semibold text-white bg-primary rounded-lg hover:bg-primary/80 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 focus:ring-offset-gray-900 transition-colors duration-300">
                        {{ __('Register') }}
                    </button>
                </div>
            </form>
